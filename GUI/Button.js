...
export default class Button extends BaseElement {
    constructor (id, position, sprite, text, style, cb) {
        ...
        if (style.bitmap) {
            ...
            this._text.position.x = this._sprite.position.x - this._text.width / 2; // eslint-disable-line no-magic-numbers
            this._text.position.y = this._sprite.position.y - this._text.height / 2; // eslint-disable-line no-magic-numbers
        }
        else {
        ...
        if (text !== "" && style.size_override === false) {
            this._sprite.width = this._text.width + 20; // eslint-disable-line no-magic-numbers
            this._sprite.height = this._text.height + 20; // eslint-disable-line no-magic-numbers
        }
    }
